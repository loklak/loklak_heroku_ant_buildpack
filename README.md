...
It uses Apache Ant 1.9.1 to build your application and OpenJDK 1.6.0_20 to run it.
...
Example usage:
	...
	-----> Java (using Apache Ant 1.9.1) app detected
	-----> Installing Apache Ant 1.9.1.....done!
